...
const AppHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 lg:ml-0">
      <div className="flex h-16 items-center justify-end gap-3 px-4 md:px-6">
        <div className="relative" ref={notificationRef}>
          ...
          {notificationsOpen && (
            <div className="dropdown-content-pro absolute right-0 z-50 mt-2 w-[320px] max-w-[90vw] overflow-hidden md:w-[360px]">
              <div className="flex items-center justify-between border-b border-border px-4 py-3">
                ...
                <button
                  ...
                  className="flex shrink-0 items-center gap-1 text-xs font-medium text-primary transition-opacity hover:opacity-80"
                  type="button"
                >
        ...
        <div className="relative" ref={profileRef}>
          <button
            ...
            type="button"
            className="flex max-w-[260px] items-center gap-3 rounded-full border border-border bg-background px-2 py-1.5 transition-colors hover:bg-accent"
          >
          ...
          {profileOpen && (
            <div className="dropdown-content-pro absolute right-0 z-50 mt-2 w-80 max-w-[92vw] overflow-hidden">
              ...
              <div className="space-y-3 border-b border-border px-4 py-4">
                <div className="flex items-center gap-2 text-sm text-foreground">
                  ...
                  <span className="truncate">{tipoUtilizador}</span>
                </div>
                ...
                <div className="flex items-center gap-2 text-sm text-foreground">
                  ...
                  <span className="truncate">{telefoneUtilizador}</span>
                </div>
